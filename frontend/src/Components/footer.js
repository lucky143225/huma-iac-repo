  ...
  return (
    <footer className="mt-[10vmax] p-[2vmax] bg-[#26abff] text-black flex items-center" id='footer'>
      ...
      <div className="w-[60%] text-center">
        <h1 className="text-[2vmax] font-roboto text-teal-700">Liasion Consultancy Services</h1>
      ...
      <div className="w-[20%] flex flex-col items-center">
        <h4 className="font-roboto text-[1.6vmax] text-crimson">Follow Us</h4>
        <a href="http://instagram.com" className="text-black text-[1.3vmax] font-[Gill Sans], sans-serif transition-all duration-500 my-[0.5vmax] hover:text-[#eb4034]">
          Instagram
        </a>
        <a href="http://youtube.com" className="text-black text-[1.3vmax] font-[Gill Sans], sans-serif transition-all duration-500 my-[0.5vmax] hover:text-[#eb4034]">
          Youtube
        </a>
        <a href="http://instagram.com" className="text-black text-[1.3vmax] font-[Gill Sans], sans-serif transition-all duration-500 my-[0.5vmax] hover:text-[#eb4034]">
          Facebook
